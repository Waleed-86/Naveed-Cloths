...
const NAV_ITEMS = [
  ...
  { label: 'Products', to: '/admin/products', ready: false },
  { label: 'Categories', to: '/admin/categories', ready: false },
  { label: 'Customers', to: '/admin/customers', ready: false },
  { label: 'Reviews', to: '/admin/reviews', ready: false },
